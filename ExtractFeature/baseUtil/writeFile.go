...
func (w *MyWriteFile) OpenFile(filename string) {
	...
	data := "SrcIP,SrcPort,DstIP,DstPort,duration,protocol_type,service,flag,src_bytes,dst_bytes,srv_serror_rate,srv_rerror_rate,same_srv_rate,diff_srv_rate," +
		"dst_host_same_srv_rate,dst_host_diff_srv_rate,dst_host_srv_serror_rate,dst_host_srv_rerror_rate,label\n"
